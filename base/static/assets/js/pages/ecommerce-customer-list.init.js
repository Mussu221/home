...
var isValue = (isCount = new DOMParser().parseFromString(
  ...
  idField = document.getElementById("id-field1"),
  customerNameField = document.getElementById("customername-field1"),
  emailField = document.getElementById("email-field1"),
  dateField = document.getElementById("date-field1"),
  phoneField = document.getElementById("phone-field1"),
  statusField = document.getElementById("status-field1"),
  addBtn = document.getElementById("add-btn1"),
  editBtn = document.getElementById("edit-btn1"),
  removeBtns = document.getElementsByClassName("remove-item-btn1"),
  editBtns = document.getElementsByClassName("edit-item-btn1");
...
var count = 11,
  statusVal =
    ...
    editBtn.addEventListener("click", function (e) {
      document.getElementById("exampleModalLabel1").innerHTML = "Edit Customer";
  ...
  "undefined" != typeof ids_array && 0 < ids_array.length
    ? Swal.fire({
        ...
        if (e.value) {
          ...
          (document.getElementById("checkAll1").checked = !1),
            Swal.fire({
              title: "Deleted!",
